...
const reviews = [
  {
    ...
    rating: 5,
    text: "Ik had helemaal geen ervaring, maar mijn instructeur was rustig, geduldig en duidelijk. Ik ben in één keer geslaagd en voel me nu zeker in het verkeer.",
    role: "Leerling"
  },
  {
    name: "Sofia L.",
    ...
    rating: 5,
    text: "De rijschool was erg flexibel met tijden. Mijn instructeur gaf altijd nuttige tips. Ik was goed voorbereid en ben zonder stress geslaagd voor mijn examen.",
    role: "Leerling"
  },
  {
    name: "David P.",
    ...
    rating: 5,
    text: "Ik vond de moderne auto en professionele aanpak top. Elke les was duidelijk en goed opgebouwd. Dankzij hun hulp heb ik snel vertrouwen opgebouwd en gehaald.",
    role: "Leerling"
  },
  {
    name: "Noah S.",
    ...
    rating: 5,
    text: "Rijles in het Engels was geen probleem. De instructeur legde alles duidelijk uit en hield rekening met mijn tempo. Binnen een paar maanden was ik geslaagd.",
    role: "Leerling"
  }
]
        ...
        <div className="text-center">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="flex items-center justify-center sm:justify-start mb-2">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
              </div>
              <p className="text-gray-600 font-medium text-sm sm:text-base md:text-lg">14 Google reviews</p>
            </div>
          </div>
        </div>
      </div>
