              ...
              {category.packages.map((pkg, index) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col flex-grow">
                    ...
                    <Link 
                      href={pkg.link}
                      className={`w-full inline-flex items-center justify-center gap-2 sm:gap-3 px-5 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 rounded-xl font-bold transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base group/btn uppercase tracking-wide ${
                        pkg.popular
