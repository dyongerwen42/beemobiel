...
export default function VoorwaardenHeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/terms-and-conditons-scaled.webp"
          alt="Voorwaarden en beleid"
          fill
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-8 sm:py-10 md:py-12 lg:py-14 text-center">
        ...
        >
          Onze algemene voorwaarden en beleid. Alles wat je moet weten over onze diensten, betalingen en annuleringen.
        </p>
      </div>
    </section>
  )
