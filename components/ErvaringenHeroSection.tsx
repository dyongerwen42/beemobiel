...
export default function ErvaringenHeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-8 sm:py-10 md:py-12 lg:py-14 text-center">
        ...
        >
          Lees wat onze leerlingen zeggen over hun ervaring bij BeeMobiel. Echte verhalen van echte mensen die hun rijbewijs hebben gehaald met onze hulp.
        </p>
      </div>
    </section>
  )
