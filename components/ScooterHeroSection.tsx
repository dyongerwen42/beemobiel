...
export default function ScooterHeroSection() {
    ...
    <section ref={ref} className="relative min-h-[35vh] sm:min-h-[40vh] md:min-h-[45vh] lg:min-h-[50vh] flex items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8 py-8 sm:py-10 md:py-12 lg:py-14 text-center`}>
        ...
        <h1 className={`text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold text-white mb-1 sm:mb-1.5 md:mb-2 leading-[1.15] sm:leading-[1.1] md:leading-[1.05] tracking-tight text-shadow-lg transition-opacity duration-700 px-2 ${isIntersecting ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '0.1s' }}>
          Voor elk tempo een passend lespakket
        </h1>
        ...
        <p className={`text-xs sm:text-sm md:text-base text-white/90 max-w-2xl mx-auto leading-relaxed text-shadow-md transition-opacity duration-700 px-2 ${isIntersecting ? 'opacity-100' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          Kies het pakket dat bij je past — of je nu snel je rijbewijs wilt halen of rustig opbouwt. Wij begeleiden je van start tot finish.
        </p>
      </div>
    </section>
  )
