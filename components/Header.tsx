          ...
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            ...
            <div className="hidden lg:flex items-center space-x-1 xl:space-x-2 flex-shrink-0">
              ...
              <a 
                ...
                className="relative group/call ml-2 xl:ml-3"
                aria-label="Bel ons direct"
              >
                <div className="relative bg-yellow-600 text-gray-900 px-4 xl:px-5 py-2.5 xl:py-3 rounded-xl font-black text-xs xl:text-sm shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 overflow-hidden">
                  <span className="relative z-10 flex items-center gap-2">
                    <svg 
                      className="w-4 h-4 xl:w-5 xl:h-5 transform group-hover/call:scale-110 transition-transform duration-300" 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span className="hidden xl:inline">Bel Nu</span>
                  </span>
                </div>
              </a>
      ...
      >
        ...
        <div className={`absolute top-0 right-0 h-full w-80 max-w-[90vw] sm:max-w-[85vw] bg-gray-900 shadow-xl border-l-2 border-yellow-600/30 transform transition-transform duration-500 ease-out ${
          ...
          <div className="h-full overflow-y-auto p-4 sm:p-5 md:p-6 space-y-1">
            ...
            <div className="pt-6 mt-6 border-t-2 border-yellow-600/20 space-y-3">
              <a
                href="tel:+31712203046"
