...
const individualRates = [
  { service: "Losse Rijles", price: "€50" },
  { service: "Theorie-examen AM", price: "€60" },
  { service: "Praktijkexamen AM", price: "€245" },
  { service: "iTheorie", price: "€50" }
]

export default function ScooterIndividualRatesSection() {
